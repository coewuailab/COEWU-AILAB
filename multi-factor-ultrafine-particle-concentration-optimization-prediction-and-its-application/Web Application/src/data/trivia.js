...
const TRIVIA_DATA = {
        'PCvsPM': [
            ...
            },
            {
                ...
                description: [
                    ...
                    'ผลกระทบ: PC0.1 อันตรายกว่าเนื่องจากขนาดเล็กมาก สามารถแทรกซึมเข้าสู่ร่างกายได้ทุกส่วนได้ง่ายกว่าพวก PM ที่มีขนาดใหญ่กว่า',
                ]
            },
            {
    ...
    'PC0.1': {
        title: 'PC0.1 (อนุภาคขนาดเล็ก)',  
        description: 'PC0.1 คือการนับจำนวนอนุภาคขนาดเล็กที่มีเส้นผ่านศูนย์กลาง 0.1 ไมโครเมตร วัดเป็นอนุภาคต่อลูกบาศก์เซนติเมตร (PNC) ใช้ในการประเมินคุณภาพอากาศในพื้นที่ที่มีมลพิษสูง',
        sources: 'Adapted from WHO global air quality guidelines',
        'short-term': [
    ...
    'HourlyMeanPC0.1': {
        ...
        description: 'ค่าเฉลี่ยรายชั่วโมงของจำนวนอนุภาคขนาดเล็ก (PC0.1) วัดเป็นอนุภาคต่อลูกบาศก์เซนติเมตร (PNC) หากระดับต่ำกว่า 20,000 อนุภาค/ลูกบาศก์เซนติเมตรใน 1 ชั่วโมงเป็นเกณฑ์ Hazardous ในส่วนเกณฑ์อื่น ๆ จะใช้เกณฑ์เดียวกับ PC0.1 (Good, Warning, Affects health, Danger)',
        sources: 'Adapted from WHO global air quality guidelines',
        'short-term': [
            'การระคายเคืองต่อระบบทางเดินหายใจ',
            'อาการไอหรือหายใจลำบาก'
    ...
    'DailyMeanPC0.1': {
        ...
        description: 'ค่าเฉลี่ยรายวันของจำนวนอนุภาคขนาดเล็ก (PC0.1) วัดเป็นอนุภาคต่อลูกบาศก์เซนติเมตร (PNC) หากระดับต่ำกว่า 1,000 อนุภาค/ลูกบาศก์เซนติเมตรใน 1 วันเป็นเกณฑ์ Good และ หากระดับต่ำกว่า 10,000 อนุภาค/ลูกบาศก์เซนติเมตรใน 1 วัน เป็นเกณฑ์ Hazardous ในส่วนเกณฑ์อื่น ๆ จะใช้เกณฑ์เดียวกับ PC0.1 (Affects health, Danger)',
        sources: 'Adapted from WHO global air quality guidelines',
        'short-term': [
            'การระคายเคืองต่อระบบทางเดินหายใจ'
        ],
...
const TriviaPopupContent = ({ onClose }) => {
    ...
    const topics = [
        ...
        { key: 'PC0.1', title: TRIVIA_DATA['PC0.1'].title },
