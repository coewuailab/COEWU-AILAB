...
TOP_MODELS_TO_SAVE = 2  # จำนวนโมเดลที่ดีที่สุดที่จะบันทึกไว้
...
def train_and_evaluate_model_expanding(model, train_loader, val_loader, test_loader, criterion, optimizer,
    ...
    """
    เทรนและประเมินโมเดล LSTM โดยใช้เทคนิค Expanding Window
...
if __name__ == "__main__":
    ...
    file_path = 'processed_data_1min_RNN-LSTM-GRUCompleted.csv'  # แก้ไขเป็นพาธของไฟล์ของคุณ
